...
export class AccountService {
  ...
  fetch(): Observable<HttpResponse<Account>> {
    return this.http.get<Account>(SERVER_API_URL + 'services/adventureuaa/api/account', { observe: 'response' });
  }

  save(account: any): Observable<HttpResponse<any>> {
    return this.http.post(SERVER_API_URL + 'services/adventureuaa/api/account', account, { observe: 'response' });
  }
