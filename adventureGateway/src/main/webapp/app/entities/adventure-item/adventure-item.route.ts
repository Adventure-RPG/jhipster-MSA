...
export class AdventureItemResolve implements Resolve<IAdventureItem> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<AdventureItem> {
