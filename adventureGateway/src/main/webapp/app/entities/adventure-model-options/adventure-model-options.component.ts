...
export class AdventureModelOptionsComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.adventureModelOptionsService
                ...
                .subscribe(
                    (res: HttpResponse<IAdventureModelOptions[]>) => this.paginateAdventureModelOptions(res.body, res.headers),
    ...
    trackId(index: number, item: IAdventureModelOptions) {
        return item.id;
    }

    registerChangeInAdventureModelOptions() {
        this.eventSubscriber = this.eventManager.subscribe('adventureModelOptionsListModification', response => this.loadAll());
    }
    ...
    protected paginateAdventureModelOptions(data: IAdventureModelOptions[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.adventureModelOptions = data;
    }
