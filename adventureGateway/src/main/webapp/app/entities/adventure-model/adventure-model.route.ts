...
export class AdventureModelResolve implements Resolve<IAdventureModel> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<AdventureModel> {
...
export const adventureModelPopupRoute: Routes = [
    {
        path: 'adventure-model/:id/delete',
