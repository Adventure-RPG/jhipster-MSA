...
export class AdventureSkillResolve implements Resolve<IAdventureSkill> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<AdventureSkill> {
...
export const adventureSkillPopupRoute: Routes = [
    {
        path: 'adventure-skill/:id/delete',
