...
/**
 * Test class for the AdventureCategoryTypeResource REST controller.
 *
 * @see AdventureCategoryTypeResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, AdventureGatewayApp.class})
public class AdventureCategoryTypeResourceIntTest {
    ...
    public void getNonExistingAdventureCategoryType() throws Exception {
        // Get the adventureCategoryType
        restAdventureCategoryTypeMockMvc.perform(get("/api/adventure-category-types/{id}", ))
    ...
    public void dtoEqualsVerifier() throws Exception {
        ...
        adventureCategoryTypeDTO1.setId();
        ...
        adventureCategoryTypeDTO2.setId();
        assertThat(adventureCategoryTypeDTO1).isNotEqualTo(adventureCategoryTypeDTO2);
