...
public class AdventureFractionResourceIntTest {
    ...
    public void getNonExistingAdventureFraction() throws Exception {
        // Get the adventureFraction
        restAdventureFractionMockMvc.perform(get("/api/adventure-fractions/{id}", ))
