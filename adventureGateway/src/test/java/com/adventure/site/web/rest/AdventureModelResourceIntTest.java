...
public class AdventureModelResourceIntTest {
    ...
    public void getNonExistingAdventureModel() throws Exception {
        // Get the adventureModel
        restAdventureModelMockMvc.perform(get("/api/adventure-models/{id}", ))
