...
public class AdventureSkillResourceIntTest {
    ...
    public void getNonExistingAdventureSkill() throws Exception {
        // Get the adventureSkill
        restAdventureSkillMockMvc.perform(get("/api/adventure-skills/{id}", ))
