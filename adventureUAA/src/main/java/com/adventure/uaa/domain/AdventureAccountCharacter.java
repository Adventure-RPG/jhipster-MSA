...
public class AdventureAccountCharacter implements Serializable {
    ...
    @JoinTable(name = "adventure_account_character_adventure_skill",
               joinColumns = @JoinColumn(name = "adventure_account_characters_id", referencedColumnName = "id"),
               inverseJoinColumns = @JoinColumn(name = "adventure_skills_id", referencedColumnName = "id"))
